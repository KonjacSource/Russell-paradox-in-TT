...
Might the easiest way to formalize Russell's paradox in Type Theory with type in type. Requires the use of sigma and identity types and UIP (This is not required if you are using extensional identity).
